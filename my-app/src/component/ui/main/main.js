...
function main() {
    const infoComponent = infoData.map(info =>  <MyTag question={info.question} punchLine={info.punchLine} />)
    ...
    return (
        ...
        <ContactCard 
              contact={{name: "Mr. Whiskerson", phone: "(212) 555-1234", email: "mr.whiskaz@catnap.meow"}}
        />

        <div>
          Hello {state.name + " space " + state.age} more text
        </div>
